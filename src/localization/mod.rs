    ...
    pub fn provider_auth_error(self, provider: ProviderId) -> (&'static str, &'static str) {
        ...
        match provider {
            ...
            ProviderId::OpenCodeZen => (
                strings.opencode_zen_token_expired_title,
                strings.opencode_zen_token_expired_body,
            ),
        }
    }
...
pub struct Strings {
    ...
    pub opencode_zen_model: &'static str,
    ...
    pub opencode_zen_token_expired_title: &'static str,
    pub opencode_zen_token_expired_body: &'static str,
    ...
    pub opencode_zen_window_title: &'static str,
}
